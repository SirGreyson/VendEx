...
public class ShopCreationMenu extends Menu {

    private Inventory menuInventory;
    private Map<Integer, String> menuCmds;

    public ShopCreationMenu(String menuTitle, int menuSize) {
    ...
    public void loadMenu() {
        ...
        for(int i = 0; i < getSize(); i++) {
            ConfigurationSection iSec = MenuHandler.menuConfig.getConfigurationSection("createShopMenu.menuItems." + i);
            if(iSec != null) {
